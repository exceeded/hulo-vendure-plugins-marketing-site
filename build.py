...
PLUGINS = [
    ...
    },
    {
        ...
        'features': [
            ...
            ('Manual review queue', 'Held orders wait for a human. Approve releases fulfilment and emails the customer; reject cancels and notifies. Optional Slack ping per held order and a per-channel auto-approve timer so nothing strands over a weekend. Notes + full audit trail on every decision.'),
